...
**Catalog: `ideas/mastery-finance-100/mastery-finance-100.md`**

Do-first order lives in `ideas/mastery-finance-100/mastery-finance-100-RANKING.md`. Start at rank 1 and go in order.

| Rank | Start with |
|------|------------|
| 1 | The Finance Concept Map |
| 2 | The Four Routes: PhD, CFA, MFE-Quant, ETA |
| 3 | Time Value of Money & Financial Math |
...
FOUR HONEST ROUTES. The academic PhD is asset-pricing and econometrics research, too theoretical to run money. The CFA plus an MBA and experience is the route to manage money or advise. The MFE and quant path is for algorithmic and machine-learning trading, and is the door built for a coder. Entrepreneurship through acquisition is the route to own businesses.


## Safety layer (binding)

- **Managing or advising on other people's money is REGULATED.** The legal authority comes from an investment-adviser or broker-dealer registration, not from a credential.
- **The Advisers Act, FINRA and Reg BI, and the Investment Company Act and Reg D for funds** all apply, and any real use needs securities counsel.
- **Every build is a STUDY or PAPER MOCK-UP.** It is not advice, not a recommendation, not a solicitation, and not a track record.
- **A BACKTEST IS NOT A PREDICTION.** Look-ahead, survivorship, overfitting, and cost biases are assumed present until shown otherwise.


## The binding contract (what every project here must carry)

- **Point of view.** PoV-M, the learner-principal. Every payload is written as someone building command of finance, weighted to the quantitative and algorithmic side by doing, never as a textbook narrator. The persona is binding on all payloads (rule 1).
